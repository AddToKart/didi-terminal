...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            services::security::is_pin_enabled,
            services::security::disable_workspace_pin,
            services::db_client::db_query_postgres,
            ...
            services::sqlite::load_all_project_comments,
            services::sqlite::save_code_review_comment,
            services::sqlite::delete_code_review_comment,
