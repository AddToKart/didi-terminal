...
export function SettingsModal({ onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-app-panel/80 backdrop-blur-sm flex items-center justify-center p-8">
      <div className="bg-app-bg border border-app-border rounded shadow-md w-full max-w-md flex flex-col max-h-full overflow-y-auto">
        ...
        <form onSubmit={handleSave} className="p-4 space-y-4">
          <div className="flex gap-4">
            <div className="space-y-1 flex-1">
              <label className="text-[10px] font-bold text-slate-500 font-medium tracking-tight">Theme Mode</label>
              <select 
                value={config.theme_mode}
                onChange={e => setConfig({...config, theme_mode: e.target.value})}
                className="w-full bg-app-panel border border-app-border text-slate-200 px-3 py-2 text-xs outline-none focus:border-brand-accent appearance-none cursor-pointer"
              >
            ...
            <div className="space-y-1 flex-1 flex flex-col justify-end">
              <label className="flex items-center gap-2 cursor-pointer h-full pb-2">
                ...
                />
                <span className="text-xs text-slate-300">Glassmorphism</span>
              </label>
            </div>
          </div>
          <div className="space-y-1">
            ...
            <input 
              ...
              className="w-full bg-app-panel border border-app-border text-slate-200 px-3 py-2 text-xs outline-none focus:border-brand-accent"
            />
            ...
            <div className="space-y-1 flex-1">
              ...
              <div className="flex items-center gap-2">
                <input 
                  ...
                  className="bg-app-panel border border-app-border h-8 w-12 cursor-pointer"
                />
